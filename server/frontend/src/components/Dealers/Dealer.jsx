...
const Dealer = () => {
  ...
  useEffect(() => {
    ...
    if(sessionStorage.getItem("username")) {
      setPostReview(<div><a className="d-flex text-decoration-none linkc" href={post_review}><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 24 24" width="1em" fill="currentColor" style={{fontSize: "20pt"}}>
